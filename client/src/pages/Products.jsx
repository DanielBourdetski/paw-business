...
const Products = () => {
  ...
  const addProductButton = isAdmin ? (
    <div
      ...
      className="fixed z-10 right-10 w-20 h-20 duration-150 bottom-20 md:bottom-32 cursor-pointer hover:-translate-y-2"
    >
      <BsFilePlus className="h-fit w-20 backdrop-blur-sm fill-slate-600 hover:fill-primary duration-150" />
      <p
