	...
	return (
		<div className='grid grid-cols-3 w-full justify-items-stretch'>
			<button
				...
				className='h-8 w-8 ml-auto flex border rounded-full items-center self-center mr-2 justify-center font-mono border-slate-300 bg-white justify-self-end hover:bg-slate-200 disabled:opacity-30 hover:disabled:bg-white'>
				{'<'}
			</button>
			<div className='flex mx-auto my-4 w-full justify-between relative'>
